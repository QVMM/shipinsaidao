...
/**
 * Capture microphone audio locally. Speech begins above a conservative RMS
 * threshold and auto-finishes after a short silence; clicking the mic again
 * can also call session.stop().
 */
